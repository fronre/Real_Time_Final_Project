...
async def handle_websocket(websocket, path):
    ...
    try:
        while True:
            ...
            base_prices = {"BTC": 45000, "ETH": 3000, "USDT": 1, "PUBG_UC": 0.01, "COD_POINTS": 0.02}
            ...
            print(f"Sent: {symbol} @ ${current_price:.2f} | Balance: ${trading_engine.balance:.2f} | Trades: {trading_engine.trade_count}")
            
            await asyncio.sleep(0.5)  # 2 updates per second (slower for visibility)
